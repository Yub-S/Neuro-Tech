...
if __name__ == "__main__":
        ...
        [
            (
                ...
                if the person says, he/she wants to have a appointment scheduled for specific doctor, ask them about their fullname,contact number and the appointment_day. and return "Yes"
                """
            ),
            (
                "human","{question}"
